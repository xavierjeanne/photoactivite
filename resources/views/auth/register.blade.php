                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="address-bis"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Complément d\'adresse') }}</label>
                                <div class="col-md-6">
                                    <input id="address-bis" type="text"
                                        class="form-control @error('address-bis') is-invalid @enderror" name="address-bis"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="postal-code" type=""
                                        class="form-control @error('postal-code') is-invalid @enderror" name="postal-code"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="city" type="" class="form-control @error('city') is-invalid @enderror"
                            ...
                            <div class="form-group row">
                                <label for="siret"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Numéro Siret') }}</label>
                                <div class="col-md-6">
                                    <input id="siret" type="text" class="form-control" @error('siret') is-invalid @enderror"
                                        value="{{ old('siret') }}" name="siret" required autocomplete="siret">
                                    @error('siret')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                <label for="company"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Société') }}</label>
                                <div class="col-md-6">
                                    <input id="company" type="text" class="form-control" @error('company') is-invalid
                                        @enderror" value="{{ old('company') }}" name="company" required
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="integer" class="form-control" @error('phone') is-invalid
                                        @enderror" value="{{ old('phone') }}" name="phone" required autocomplete="phone">
                                    @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
